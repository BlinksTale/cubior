...
{
    float guessLocation = mod(value/100.0+0.5, 1.0);
    float actualLocation = mod(value/100.0+0.5-tinyAmount, 1.0);
    return guessLocation >= 1.0 - tinyAmount*2.0 ||  guessLocation <= tinyAmount ? actualLocation : mod(value/100.0+0.5-tinyAmount+time, 1.0);
}
